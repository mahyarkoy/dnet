...
from pylayers import PyBackMultLayer, PyWeightedMeanLoss, PyLeastSquareLoss
...
net.f(Power(idata, bottoms=['pp'], scale=1))
...
net.f(PyLeastSquareLoss(loss, bottoms=[output, gt], loss_weight=1.0))
